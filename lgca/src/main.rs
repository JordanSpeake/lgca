...
fn print_progress(i: usize, f: usize, start_time: Instant, config: &Config) {
    ...
    print!("frame: {}/{} ", f + 1, config.iterations / config.frameskip);
...
fn main() {
    ...
    grid_a.fill_boundary(0, 1024, 4096, 128);
    grid_a.fill_region(1848, 1024, 128, 200, 0.25);
    grid_a.fill_region(2248, 1024, 128, 200, 0.25);
